...
class Booking(webdriver.Chrome): 
    def __init__(self, driver_path=r"C:\SeleniumDrivers", teardown=False):
        ...
        options = webdriver.ChromeOptions() # For removing warnings that appear in the terminal 
    ...
    def select_place_to_go(self, place_to_go):
        ...
        search_field.clear() # Clearing the existing text 
    ...
    def report_results(self): 
        hotel_boxes =self.find_element_by_css_selector('div[data-block-id="hotel_list"]')
